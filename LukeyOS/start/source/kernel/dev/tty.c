 ...
 * @Description: 终端tty
 * @Author: Alvin
 * @Date: 2023-05-29 10:57:04
 * @LastEditTime: 2023-06-05 16:21:14
 */
#include "dev/tty.h"
...
/**
 * @brief: TTY FIFO初始化
 * @param {tty_fifo_t} *fifo 指向FIFO缓存结构体的指针
 * @param {char *} buf	存储FIFO缓存数据的缓存数组的指针
 * @param {int} size	缓存数组的大小，即缓存可容纳的最大字节数
 * @return {*}
 */
